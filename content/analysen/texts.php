<?php
    ...
    $TextNumPayments =
        "Die Bewertung der Anzahl an Auszahlungen ist hauptsächlich psychologischer Natur:
        Einkommensinvestoren bevorzugen oft Unternehmen mit den in der USA üblichen vier Auszahlungen, da so
        mit drei Aktien, deren Auszahlungstermine entsprechend versetzt getaktet sind, monatliche Auszahlungen
        erreicht werden können, analog zu einem klassischen Gehalt.
        Eine jährliche oder halbjährliche Dividende hat nur den Nachteil, dass man mit der Auszahlung länger haushalten muss.
        Mehr als vier Auszahlungen im Jahr oder gar tägliche Auszahlungen sind ungewöhnlich und mit Vorsicht zu betrachten.";

    $TextNumYears =
        "Eine hohe Anzahl an Auszahlungsjahren ist ein guter Hinweis auf ein dauerhaft stabiles Unternehmen und sichere Dividende.
        Daher werden Unternehmen die 25 Jahre oder länger Dividende zahlen auch als 'Dividendenaristokraten' bezeichnet.
