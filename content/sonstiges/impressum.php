...
<div class="container-fluid padding" id="examples">
    <div class="row welcome ">
        <div class="col-12">
            <h1 class="display-4">Haftungsausschluss - Disclaimer</h1>
        </div>
        <hr>
        <div class="col-12">
            <p class="lead">
            ...
            <p>
                ...
                von Informationen nach den allgemeinen Gesetzen bleiben hiervon unberührt.<br>
                Eine diesbezügliche Haftung ist jedoch erst ab dem Zeitpunkt der Kenntniserlangung
                einer konkreten Rechtsverletzung möglich. Bei Bekanntwerden von den o.g. Rechtsverletzungen werden wir diese Inhalte unverzüglich entfernen.
            </p>

            <p class="lead">Haftungsbeschränkung für externe Links</p>
            <p>
